...
#     def test_accommodation_empty_fields(self):
#         location = Location.objects.create(
#             id="1",
#             title="Test Location",
#             country_code="US",
...
#             country_code="US",
#             bedroom_count=None,  # Empty field, should be validated
#             review_score=None,  # Empty field, should be validated
#             usd_rate=None,  # Empty field, should be validated
