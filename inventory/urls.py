...
urlpatterns = [
    ...
    path(
        ...
        views.property_owner_signup,
        name="property_owner_signup",
    ),
    ...
    ),  # Link the URL to the custom login view
    path("property-list/", views.property_list, name="property_list"),
    ...
    path(
        "location/<slug:location_slug>/", views.location_detail, name="location_detail"
    ),
